...
export default function Sidebar({ activeView, onViewChange }: SidebarProps) {
  ...
  return (
    <aside className="w-64 bg-card border-r border border-gray-300 flex flex-col">
      {/* Logo */}
      <div className="p-6 border-b border border-gray-300">
      ...
      {/* User Profile */}
      <div className="p-4 border-t border border-gray-300">
